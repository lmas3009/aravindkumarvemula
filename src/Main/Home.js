...
import coding from '../images/programing.png'
            ...
            <Router browserHistory>
                ...
                <section id="homepage">
                    ...
                    <div className="app-text">
                        <h1>Aravind Kumar Vemula</h1>
                        <p>I am a <ReactRotatingText items={['Flutter Developer', 'Java Developer','Full stack web developer', 'UI/UX Designer']}/></p>
                        <Link to='/Project'><button  onClick="window.location.href=window.location.href" className="btn1 btn1-warning">See Projects</button></Link>
                    </div>
                ...
                <section id="skills">
                    ...
                    <div className="skill">
                        ...
                        <div className="col-sm">
                            ...
                            <li className="list-group-item active">Mobile Applications</li>
                        ...
                        <div className="col-sm-4">
                            <ul className="list-group">
                            <li className="list-group-item active">Web Applications</li>
                        ...
                        <div className="col-sm">
                            <ul className="list-group">
                            <li className="list-group-item active">Others</li>
                            <li className="list-group-item">Web UI deisgner</li>
                            <li className="list-group-item">Mobile UI designer</li>
                            </ul>
                        </div>
                        <div className="col-sm">
                            <ul className="list-group">
                            <li className="list-group-item active">Hackathons</li>
                            <li className="list-group-item">College</li>
                            <li className="list-group-item">Mobile UI designer</li>
                            </ul>
                        </div>
                        </div>
                ...
                <footer id="footer" className="footer-1">
                    ...
                    <div className="container">
                        ...
                        <div className="col-xs-12 col-sm-6 col-md-3">
                            ...
                            <h5 className="widget-title">LMAS<span /></h5>
                        ...
                        <div className="col-xs-12 col-sm-6 col-md-3">
                            ...
                            <ul className="thumbnail-widget">
                                ...
                                <li>
                                <div className="thumb-content"><a href="#.">Projects</a></div>	
                                </li>
                            </ul>
                            </div>
                        </div>
                        <div className="col-xs-12 col-sm-6 col-md-3">
                            <div className="widget no-box">
                            <h5 className="widget-title">New Projects<span /></h5>
                            <p>Coming Soon....</p>
                            </div>
                        </div>
                        <div className="col-xs-12 col-sm-6 col-md-3">
                            ...
                            <p><a title="glorythemes">aravind.kumar@klh.edu.in</a></p>
                    ...
                    <div className="container">
                        ...
                        <div className="col-md-12 text-center">
                            <p>Copyright LMAS © 2020. All rights reserved.</p>
                        </div>
                        </div>
                    </div>
                    </div>
